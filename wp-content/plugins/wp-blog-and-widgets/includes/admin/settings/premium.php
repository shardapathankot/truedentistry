...
<div class="wrap">
	...
	<h2><span class="wpbaw-sf-blue">WP Blog and Widget </span>Including in <span class="wpbaw-sf-blue">Essential Plugin Bundle</span></h2>
		...
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				...
				<div style="text-align: center; background: #DCDCDC; margin: 30px 0; padding: 10px 30px 30px 30px;">
					...
					<a href="<?php echo esc_url(WPBAW_PLUGIN_LINK_UPGRADE); ?>" target="_blank" class="wpbaw-sf-btn wpbaw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				</div>
				...
				<h2 style="font-size: 24px; text-align: center; color: #6c63ff;">Bundle Deal Details</h2>
							...
							<tr>
								...
								<td>
									<ul class="wpos-slider-list">
										...
										<li><span style="color:#2271b1; font-weight: bold;">WP Blog and Widget</span></li>
					...
					<div style="text-align: center; margin-bottom:30px">
						<h3 class="wpbaw-sf-blue" style="margin:0; margin-bottom:10px; font-size:24px; font-weight:bold;">Use Essential Plugin Bundle</h3>
					...
					<div style="text-align: center;">
						<img style="width: 100%; margin-bottom:30px;" src="<?php echo esc_url( WPBAW_URL ); ?>assets/images/image-upgrade.png" alt="image-upgrade" title="image-upgrade" />
						<div style="font-size: 14px; margin-bottom:10px;"><span class="wpbaw-sf-blue">Blog </span>Including in <span class="wpbaw-sf-blue">Essential Plugin Bundle</span></div>
						<a href="<?php echo esc_url(WPBAW_PLUGIN_LINK_UPGRADE); ?>" target="_blank" class="wpbaw-sf-btn wpbaw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Bundle Deal</a>
					</div>
			</div>
		</div>
	</div>
